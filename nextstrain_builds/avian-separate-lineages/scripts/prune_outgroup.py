...
if __name__ == '__main__':
    ...
    parser.add_argument("--ha-lineage",
        help="HA lineage, from which the HA type number can be found.")
    ...
    prune_outgroup(args.ha_lineage, args.tree_w_outgroup, args.auspice_w_outgroup, args.output_file)
